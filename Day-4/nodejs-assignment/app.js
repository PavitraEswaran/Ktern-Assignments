...
app.get("/getAllStudents", authenticateToken, async (req, res) => {
  try {
...
app.get(
  "/getAllStudentsPercentage/:percentage",
  authenticateToken,
  async (req, res) => {
...
app.get("/getStudentByID/:id", authenticateToken, async (req, res) => {
...
app.get("/getPercentageByID/:id", authenticateToken, async (req, res) => {
  const studentId = req.params.id;
  try {
...
app.post("/signup", async (req, res) => {
  ...
  try {
    const checkForUser = await dbService.getUser(email, hashedPassword);
    if (!checkForUser) {
...
app.post("/login", async (req, res) => {
  ...
  try {
    const checkForUser = await dbService.getUser(email);
    ...
    bcrypt.compare(password, checkForUser.password, (err, data) => {
...
app.post("/addNewStudent", authenticateToken, async (req, res) => {
...
app.post("/updateStudentByID/:id", authenticateToken, async (req, res) => {
...
app.get("/deleteStudentByID/:id", authenticateToken, async (req, res) => {
  const studentId = req.params.id;
  try {
    const student = await dbService.getStudentById(studentId);
